...
'use strict';
//
// Weekly blog post generator for the Dr. Usha Sri Bollineni dental site.
//
...
function buildSystem(voice) {
  return [
    'You are ghostwriting a blog article for Dr. Usha Sri Bollineni, DDS, a',
...
function scaffold(topic, siblings) {
  ...
  return {
    desc: topic.title + ' - general dental education from Dr. Usha Sri Bollineni, DDS in Overland Park, Kansas.',
...
async function main() {
  ...
  d.img = topic.img;
  d.alt = topic.alt;
  d.keywords = topic.keyword + ', dentist Overland Park, Dr. Usha Sri Bollineni';
